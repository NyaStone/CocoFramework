...
// /**
//  * Mixin function to output a class extending 
//  */
// export function mixinTableClass<TClass extends Constructor>(TheClass: TClass) {
//     return class TableClass extends TheClass {
//         /**
...
//                                 const ChildType: typeof TableClass = ParentClass.fields[field] as typeof TableClass;
...
//          */
//         static async create(fields: {[oprtName: string]: any}, ...constructorParams: any[]): Promise<TableClass> {
...
//                     if (!(fields[field] instanceof (FieldType as Constructor))) throw new Error(`Gotten instance for the ${field} field was of wrong type`);
...
//          */
//         static getByUUID(uuid: string, ...constructionData: any[]): TableClass {
